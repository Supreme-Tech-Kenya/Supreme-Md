...
zokou({ nomCom: "wagroup", reaction: "😌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    ...
    let z = 'Hello 🤍 \n\nClick The link below to Join *SUPREME-MD* WhatsApp Testing Group\n\n';
...
zokou({ nomCom: "channel", reaction: "😌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = 'Hello 🤍 \n\nClick The link below to Join *SUPREME-MD* WhatsApp Channel\n\n';
...
zokou({ nomCom: "test", reaction: "✅", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = ' *SUPREME-MD BOT IS CURRENTLY ACTIVE ☹︎*\n';
    let d = ' ❄︎ *_MADE BY SUPREME-TECH* ❄︎';
    let varmess = z + d;
    var img = 'https://telegra.ph/file/a73725681808deb94b76f.jpg';
    await zk.sendMessage(dest, { image: { url: img }, caption: varmess });
    //console.log("montest")
});
console.log("mon test");
...
zokou({ nomCom: "check", reaction: "🗿", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = ' *SUPREME-MD UPDATES*\n\n';
    let d = 'Checking for updates...⏳\n\nUpdating new version...⏳\n\ndone....✅\n\n *SUPREME-MD NEW VERSION SUCCESSFULLY INSTALLED...* ';
    let varmess = z + d;
    var img = ''https://telegra.ph/file/a73725681808deb94b76f.jpg;
    await zk.sendMessage(dest, { image: { url: img }, caption: varmess });
    //console.log("montest")
...
zokou({ nomCom: "version", reaction: "⏳", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = ' *YOU ARE CURRENTLY USING SUPREME-MD\n\n';
